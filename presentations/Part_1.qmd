...
Calculate the mean, standard deviation ([sd()]{.callout-code}), and replicates ([n()]{.callout-code}) of [body_mass_g]{.callout-code} for the different species and sexes in [dat_penguins]{.callout-code}.
:::
::::
